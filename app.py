...
analyser = ExerciseFactory.create_exercise_analyser("shoulder press") # object from factory created
vid = cv2.VideoCapture("vids/shoulderpress_internet04.mp4") #internet sample
cv2.namedWindow(
    "IronEye AI",
    cv2.WINDOW_NORMAL
)
